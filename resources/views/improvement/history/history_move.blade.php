    ...
    <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-6">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('improvement.history.move.export', ['start_date' => request('start_date'), 'end_date' => request('end_date')]) }}" 
        ...
        <form action="{{ route('improvement.history.move.index') }}" method="GET" class="bg-gray-50 p-6 rounded-2xl mb-8 flex flex-wrap items-end gap-6 border border-gray-100">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('improvement.history.move.index') }}" class="px-4 py-2.5 text-gray-400 hover:text-gray-600 rounded-xl font-bold text-sm flex items-center">
                    Reset
                </a>
            </div>
        </form>
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-indigo-50/50 transition duration-150">
                        ...
                        <td class="px-6 py-5 text-sm text-center font-black text-indigo-600">{{ $item->qty }}</td>
                        <td class="px-6 py-5 text-sm font-bold text-gray-600">{{ $item->from_location }}</td>
                        <td class="px-6 py-5 text-sm font-bold text-indigo-600">{{ $item->to_location }}</td>
