    ...
    <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-6">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('improvement.history.in.export', ['start_date' => request('start_date'), 'end_date' => request('end_date')]) }}" 
        ...
        <form action="{{ route('improvement.history.in.index') }}" method="GET" class="bg-gray-50 p-6 rounded-2xl mb-8 flex flex-wrap items-end gap-6 border border-gray-100">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('improvement.history.in.index') }}" class="px-4 py-2.5 text-gray-400 hover:text-gray-600 rounded-xl font-bold text-sm flex items-center">
                    Reset
                </a>
            </div>
        </form>
